...
class Formiga {
  ...
  direita() {
    this.ambiente.ambiente[this.linha][this.coluna] = this.ambiente.temNinho(
      ...
      ? "N"
      : "V";
    this.ambiente.ambiente[this.linha][this.coluna + 1] =
      this.ambiente.temComida(this.linha, this.coluna + 1)
        ? this.pegarComida()
        : this.valor;
    this.coluna++;
    this.ambiente.mostrar();
  ...
  baixo() {
    ...
    this.ambiente.ambiente[this.linha + 1][this.coluna] =
      this.ambiente.temComida(this.linha + 1, this.coluna)
        ? this.pegarComida()
        : this.valor;
    this.linha++;
    this.ambiente.mostrar();
